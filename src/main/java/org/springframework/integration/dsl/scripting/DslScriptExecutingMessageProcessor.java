...
class DslScriptExecutingMessageProcessor
	...
	public void afterPropertiesSet() throws Exception {
		...
		ScriptSource scriptSource = new RefreshableResourceScriptSource(this.script, refreshCheckDelay);
		...
		if ("groovy".equals(this.lang.toLowerCase())) {
			this.delegate = new GroovyScriptExecutingMessageProcessor(scriptSource, this.variableGenerator);
		}
		else {
