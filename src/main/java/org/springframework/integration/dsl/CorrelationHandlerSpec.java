...
public abstract class
	...
	/**
	 * Configures the handler with a group timeout expression that evaluates to
	 * this constant value.
	...
	/**
	 * Configures the handler with a function that will be invoked to resolve the group timeout,
	...
	/**
	 * Configures the handler with an {@link ExpressionEvaluatingCorrelationStrategy} for the
	 * given expression.
	...
	/**
	 * Configures the handler with an {@link org.springframework.integration.aggregator.MethodInvokingCorrelationStrategy}
	...
	/**
	 * Configures the handler with an {@link ExpressionEvaluatingReleaseStrategy} for the
	 * given expression.
	...
	/**
	 * Configures the handler with an {@link org.springframework.integration.aggregator.MethodInvokingReleaseStrategy}
	 * for the target object and method name.
	 * @param target the target object.
	 * @param methodName the method name.
	 * @return the handler spec.
